...
if($('#soc_incorporation_date').length)
    $('#soc_incorporation_date').datepicker({ autoclose: true, dateFormat: 'yy-mm-dd'});
    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": base_url + "index.php/admin/files/society_foreign/ajax_get", // ajax source
...
function active_power() {
   ...
   if ( $('#soc_power_type').val() === "Instrumento Privado" )  {
        document.form_society_foreign.soc_private_instrument.disabled=false
        document.form_society_foreign.soc_pi_end_date.disabled=false

//        document.form_society_foreign.soc_pdn_deed_number.disabled=true
//        document.form_society_foreign.soc_pdn_deed_date.disabled=true
//        document.form_society_foreign.soc_pdn_notary.disabled=true
//        document.form_society_foreign.soc_pdn_power_due_date.disabled=true
//
//        document.form_society_foreign.soc_pdr_deed_number.disabled=true
//        document.form_society_foreign.soc_pdr_deed_date.disabled=true
//        document.form_society_foreign.soc_pdr_notary.disabled=true
//        document.form_society_foreign.soc_pdr_deed_reg_date.disabled=true
//        document.form_society_foreign.soc_pdr_elec_folio.disabled=true
//        document.form_society_foreign.soc_pdr_power_due_date.disabled=true

   } else if ( $('#soc_power_type').val() === "Escritura Pública No Inscrita" ){
        document.form_society_foreign.soc_private_instrument.disabled=true
        document.form_society_foreign.soc_pi_end_date.disabled=true

//        document.form_society_foreign.soc_pdn_deed_number.disabled=false
//        document.form_society_foreign.soc_pdn_deed_date.disabled=false
//        document.form_society_foreign.soc_pdn_notary.disabled=false
//        document.form_society_foreign.soc_pdn_power_due_date.disabled=false
//
//        document.form_society_foreign.soc_pdr_deed_number.disabled=true
//        document.form_society_foreign.soc_pdr_deed_date.disabled=true
//        document.form_society_foreign.soc_pdr_notary.disabled=true
...
//        document.form_society_foreign.soc_pdn_power_due_date.disabled=true
//
//        document.form_society_foreign.soc_pdr_deed_number.disabled=false
//        document.form_society_foreign.soc_pdr_deed_date.disabled=false
//        document.form_society_foreign.soc_pdr_notary.disabled=false
//        document.form_society_foreign.soc_pdr_deed_reg_date.disabled=false
//        document.form_society_foreign.soc_pdr_elec_folio.disabled=false
//        document.form_society_foreign.soc_pdr_power_due_date.disabled=false
    }

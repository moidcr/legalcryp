if($('#contact_personalid_expiration').length)
    $('#contact_personalid_expiration').datepicker({ autoclose: true, dateFormat: 'yy-mm-dd'});

if($('#contact_birthday').length)
    $('#contact_birthday').datepicker({ autoclose: true, dateFormat: 'yy-mm-dd',  startView: "-15y", endDate: "-15y"});

if($('#birthday').length)
    $('#birthday').datepicker({dateFormat: 'yy-mm-dd',  startView: "-15y", endDate: "-15y"});

if($('#personalid_expiration').length)
    $('#personalid_expiration').datepicker({dateFormat: 'yy-mm-dd'});
    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": base_url + "index.php/admin/content/natural_person/ajax_get", // ajax source

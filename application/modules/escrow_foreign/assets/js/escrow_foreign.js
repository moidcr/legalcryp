    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": base_url + "index.php/admin/files/escrow_foreign/ajax_get", // ajax source
...
$(document).on('change','#esc_person_id',function(){
            ...
            $.ajax({ url: base_url + "index.php/admin/files/escrow_foreign/person_contacts",
               type: "POST",
...
function active_power() {
   ...
   if ( $('#esc_doc_type').val() === "Instrumento Privado" )  {
        document.form_escrow_foreign.esc_pi_sign_authentication.disabled=false


   } else if ( $('#esc_doc_type').val() === "Escritura Pública" ){
        document.form_escrow_foreign.esc_pi_sign_authentication.disabled=true

...
if($('#esc_fecha_registro').length)
    $('#esc_fecha_registro').datepicker({ autoclose: true, dateFormat: 'yy-mm-dd'});
    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": base_url + "index.php/admin/files/escrow_pty/ajax_get", // ajax source
...
$(document).on('change','#esc_person_id',function(){
            ...
            $.ajax({ url: base_url + "index.php/admin/files/escrow_pty/person_contacts",
               type: "POST",

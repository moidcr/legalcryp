...
/**
 * \file    test/phpunit/TimeSpentToSalaryFunctionalTest.php
...
/**
 * Class TimeSpentToSalaryFunctionalTest
 *
 ...
 *
 * @package Testtimespenttosalary
 */
class TimeSpentToSalaryFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTimeSpentToSalary')->click();
		} else {
			// Disable the module
			$this->byHref('modTimeSpentToSalary')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/timespenttosalary/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('timespenttosalary/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/timespenttosalary/admin/about.php');
		$this->authenticate();
		return $this->assertContains('timespenttosalary/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('timespenttosalarywidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTimeSpentToSalary_TimeSpentToSalaryTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTimeSpentToSalary_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
